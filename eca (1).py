...
Original file is located at
    https://colab.research.google.com/drive/117327g3UlAw8Ak74iot3nSLkC0YreQ7W
"""
...
# Load the model
model_path = '/content/sample_data/emotion_classification_model.h5'  # Replace with the actual path
model = load_model(model_path)

# Load the tokenizer

tokenizer_path = '/content/sample_data/tokenizer.pickle' # Update with the actual path to your tokenizer file
...
if st.button("Classify"):
    if user_input:
        ...
        emotion_labels = ['anger', 'disgust', 'fear', 'joy', 'sadness', 'surprise']  # Update according to your dataset
